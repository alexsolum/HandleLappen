...
plan: 01
subsystem: ui
tags: [svelte, tailwind, mobile, dialog, layout]
requires:
  - phase: 05-pwa-and-offline-support
    provides: protected shell, fixed bottom layers, offline state
provides:
...
affects: [09-02, 09-03, mobile-ui, barcode, categories]
tech-stack:
  added: []
  patterns: [inset mobile sheet shell, capped 100dvh card, internal scroll plus sticky footer]
key-files:
  created: []
  modified:
