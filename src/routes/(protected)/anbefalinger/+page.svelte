...
<div class="mx-auto max-w-lg px-4 py-6">
  ...
  {#if data.historyGroups.length === 0}
    <div class="mb-4">
      <h2 class="mb-2 text-sm font-semibold text-gray-900">Historikk</h2>
    </div>
  ...
  {:else}
    <div class="space-y-6">
      <div>
        <h2 class="text-sm font-semibold text-gray-900">Historikk</h2>
        <p class="text-xs text-gray-500">Dato-gruppert og klar for rask skanning.</p>
      </div>
